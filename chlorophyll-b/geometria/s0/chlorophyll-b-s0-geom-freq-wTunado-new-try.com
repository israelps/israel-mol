--Link1--
%NProcShared=20
%Chk=chlorophyll-b-s0-geom-freq-wTunado-new-try-pm6.chk
%Mem=30GB
...
%Mem=30GB
#n iop(3/107=0140000000,3/108=0140000000) iop(3/107=0140000000,3/108=0140000000) CAM-B3LYP/6-31G(d,p) Opt=ReadFC Geom=Checkpoint Guess=Read Freq=(SaveNormalModes,NoRaman)
